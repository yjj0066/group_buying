...
import { translateCategories } from "@lib/util/translate-content"
...
export default async function Footer() {
  ...
  try {
    ...
    productCategories =
      (await translateCategories((await listCategories()) ?? [], localeCode)) ??
      []
  } catch {
    productCategories = []
  }
      ...
      <div className="content-container flex flex-col w-full">
        ...
        <div className="flex w-full mb-16 justify-between text-ui-fg-muted">
          <Text className="txt-compact-small">
            © {new Date().getFullYear()} {t.nav.storeName}. {t.footer.copyright}
          </Text>
        </div>
      </div>
    </footer>
