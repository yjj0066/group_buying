...
import SellerUrgentFillView from "@modules/group-buying/components/seller-urgent-fill-view"

type Props = {
  params: Promise<{ countryCode: string; dealId: string }>
}

export default async function SellerUrgentFillPage(props: Props) {
  ...
  return (
    <SellerUrgentFillView deal={deal} participations={participations} />
  )
}
