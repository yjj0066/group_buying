...
import SellerSeatsView from "@modules/group-buying/components/seller-seats-view"

type Props = {
  params: Promise<{ countryCode: string; dealId: string }>
}

export default async function SellerSeatsPage(props: Props) {
  ...
  return <SellerSeatsView deal={deal} participations={participations} />
}
