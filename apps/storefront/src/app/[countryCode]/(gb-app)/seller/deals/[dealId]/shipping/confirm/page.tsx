...
import SellerShippingConfirmView from "@modules/group-buying/components/seller-shipping-confirm-view"

type Props = {
  params: Promise<{ countryCode: string; dealId: string }>
}

export default async function SellerShippingConfirmPage(props: Props) {
  ...
  return (
    <SellerShippingConfirmView deal={deal} participations={participations} />
  )
}
